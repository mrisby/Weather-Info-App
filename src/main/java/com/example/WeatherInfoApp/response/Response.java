package com.example.WeatherInfoApp.response;
...
public class Response {
	...
	public Response(Map<String, String> main) {
		this.main = main;
	}
	...
	public Response(Map<String, String> coord, List<Map<String, String>> weather, String base, Map<String, String> wind,
			Map<String, String> clouds, String dt, Map<String, String> sys, String id, String name, String cod) {
		this.coord = coord;
